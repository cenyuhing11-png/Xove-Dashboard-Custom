...
test('time trace action routes inside the main view', () => assert.match(dashboard, /action === 'plan'\) \{ if \(await this\.planRenderer\.openOverview\(\)\) await this\.setSection\('timeTrace'\)/));
