...
/** Future canonical folders. Legacy folders below remain read-compatible until migration. */
export const PLAN_FOLDERS = { year: '02-年计划', quarter: '03-季计划', month: '04-月计划', week: '05-周计划' } as const;
export const LEGACY_PLAN_FOLDERS = { year: '02-年度', quarter: '03-季度', month: '04-月度', week: '05-周计划' } as const;
export const JOURNAL_FOLDERS = { day: '01-日记', week: '02-周复盘', month: '03-月复盘', quarter: '04-季复盘', year: '05-年复盘' } as const;
export const LEGACY_JOURNAL_FOLDERS = { day: '01-日记', week: '02-周记', month: '03-月度复盘', year: '04-年度复盘' } as const;
